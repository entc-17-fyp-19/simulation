...
if("TRUE" STREQUAL "TRUE")
  set(navigation_SOURCE_PREFIX /home/tharaka/ROS/fyp/catkin_ws/src/navigation)
  set(navigation_DEVEL_PREFIX /home/tharaka/ROS/fyp/catkin_ws/devel)
  ...
  set(navigation_INSTALL_PREFIX /home/tharaka/ROS/fyp/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tharaka/ROS/fyp/catkin_ws/src/navigation/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT navigation_NUM_DUMMY_TARGETS)
      set(navigation_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::navigation::wrapped-linker-option${navigation_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR navigation_NUM_DUMMY_TARGETS "${navigation_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::navigation::wrapped-linker-option${navigation_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND navigation_LIBRARIES "${interface_target_name}")
...
set(navigation_EXPORTED_TARGETS "")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(navigation_EXPORTED_TARGETS ${${navigation_dep}_EXPORTED_TARGETS})
endforeach()
